...
def sales_mart_calculation_table_write(final_sales_team_data_mart_df):
    ...
    final_sales_team_data_mart_table1 = final_sales_team_data_mart \
    ...
    db_writer.write_dataframe(final_sales_team_data_mart_table1, config.sales_team_data_mart_table)
